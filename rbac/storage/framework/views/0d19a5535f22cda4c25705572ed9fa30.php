                 ...
                 <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?php echo e(route('users.edit', $user->id)); ?>" title="Manage Selected User">
                        ...
                        <td class="text-center">
                            <!-- <a href="<?php echo e(route('users.delete', $user->id)); ?>" class="pt-.5 pb-2 px-1 bg-danger rounded" title="Remove Selected User">
                            ...
                            <form action="<?php echo e(route('users.delete', $user->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this user?');">
                    <?php echo csrf_field(); ?>
